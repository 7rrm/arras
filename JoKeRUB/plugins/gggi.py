...
from telethon.tl.functions.messages import GetStarGiftsRequest
...
async def star_gifts(event):
    ...
    try:
        ...
        # إرسال ملصق أولاً
        try:
            await event.client.send_file(event.chat_id, '5170145012310081615')  # ضع هنا رابط الملصق المطلوب
        except:
            pass  # إذا فشل إرسال الملصق، أكمل بدونها
        
        # إنشاء رسالة الرد مع المعلومات
