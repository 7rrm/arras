...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n"
            "᯽︙ شـرح عـن اوامـر المحاكاة \n\n"
            "**أوامـر الأعـلام**\n"
            "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
            "❬ `.تفعيل اعلام` ❭\n"
            "- قم بتفعيل البوت للرد على الأعلام في المجموعة الحالية.\n\n"
            "❬ `.تعطيل اعلام` ❭\n"
            "- قم بتعطيل البوت عن الرد على الأعلام في جميع المجموعات.\n\n"
            "❬ `.تفعيل نص اعلام` ❭\n"
            "- قم بتعيين نص محفز مخصص للرد على الأعلام.\n\n\n"
            "**أوامـر المعـاني**\n"
            "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
            "❬ `.تفعيل معاني` ❭\n"
            "- قم بتفعيل البوت للرد على معاني السمايلات في المجموعة الحالية.\n\n"
            "❬ `.تعطيل معاني` ❭\n"
            "- قم بتعطيل البوت عن الرد على معاني السمايلات في جميع المجموعات.\n\n"
            "❬ `.تفعيل نص معاني` ❭\n"
            "- قم بتعيين نص محفز مخصص للرد على معاني السمايلات.\n\n\n"
            "**أوامـر التفكيـك**\n"
            "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
            "❬ `.تفعيل تفكيك` ❭\n"
            "- قم بتفعيل البوت لتفكيك الكلمات في المجموعة الحالية.\n\n"
            "❬ `.تعطيل تفكيك` ❭\n"
            "- قم بتعطيل البوت عن تفكيك الكلمات في جميع المجموعات.\n\n"
            "❬ `.تفعيل نص تفكيك` ❭\n"
            "- قم بتعيين نص محفز مخصص لتفكيك الكلمات.\n\n\n"
            "**أوامـر المقالات**\n"
            "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
            "❬ `.تفعيل مقالات` ❭\n"
            "- قم بتفعيل البوت للرد على المقالات في المجموعة الحالية.\n\n"
            "❬ `.تعطيل مقالات` ❭\n"
            "- قم بتعطيل البوت عن الرد على المقالات في جميع المجموعات.\n\n"
            "❬ `.تفعيل نص مقالات` ❭\n"
            "- قم بتعيين نص محفز مخصص للرد على المقالات .\n\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n"
            "⌔︙Dev : @Lx5x5"
        )
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "〔شرح اوامر الوقتي〕:\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ❬ `.تفعيل_وقتي` ❭\nقم باستعمال الامر في الگروب وضيقته يقوم ب ارسال رساله الوقت عندما يصبح الوقت ممميزا مثل \n 12:00 - 12:12 - 1:00 - 1:01 \n\n- ❬ `.تعطيل_وقتي` ❭\nلتعطيل الامر \n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔︙Dev : @Lx5x5"
        )
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "〔شـرح عـن اوامر ترحيب البوت〕\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n ᯽︙ اختر احدى هذه الاوامر \n\n❬ `.تفعيل الترحيب` ❭\n- لتفعيل ترحيب البوت يقوم بالرد ع رسالة الترحيب ويقوم بترحيب مرا لخ \n\n❬ `.تعطيل الترحيب` ❭\n - لتعطيل الترحيب\n\n - **ملاحظه هذه الاوامر خاصه بالمطور فقط \n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n⌔︙Dev : @Lx5x5"
        )
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            ...
            "᯽︙ اختر احدى هذه الاوامر\n\n"
            "- ❬ `.ازالة` ❭\n"
            "  **الشـرح**: لإزالة بصمة معينة\n\n"
            "- ❬ `.قائمة الميمز` ❭\n"
            "  **الشـرح**: لعرض قائمة البصمات التي قمت بإضافتها\n\n"
            "- ❬ `.ازالة_البصمات` ❭\n"
            "  **الشـرح**: لإزالة جميع البصمات التي قمت بإضافتها\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n"
            "⌔︙Dev : @Lx5x5"
        )
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "〔قائمة اوامر المراقبة〕\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n- ❬ `مراقبة` ❭\n لـ مراقبة شخص . يقوم حسابك ب انشاء كروب مراقبة ويقوم بتحويل كل رسائل الشخص المراقب الى الكروب\n**~الاستخدام** : مراقبة + يوزر او ايدي الشخص\n\n- ❬ `الغاء مراقبة` ❭\n لـ الغاء المراقبة \n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔ Dev : @Lx5x5"
        )

@l313l.ar_cmd(
    pattern="اوامر نقل اليوزرات$",  # اسم الأمر الذي سيتم استدعاؤه
    command=("اوامر نقل اليوزرات", plugin_category),  # تعريف الأمر والفئة
)
async def _(event):
    # التحقق من أن الأمر لا يبدأ بحرف أبجدي أو رمز خاص
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        # عرض قائمة الأوامر
        await event.edit(
            "〔قائمة اوامر نقل اليوزرات〕\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n᯽︙ اختر احدى هذه الاوامر\n\n"
            "- ❬ `.نقل_قناة + اليوزر` ❭\n"
            "لـ نقـل اليـوزر من حسـابك إلى قنـاة جديـدة.\n"
            "**~الاستخدام** : `.نقل_قناة @username`\n\n"
            
            "- ❬ `.نقل_حساب + اليوزر` ❭\n"
            "لـ نقـل اليـوزر من قنـاة إلى حسـابك.\n"
            "**~الاستخدام** : `.نقل_حساب @username`\n\n"
            
            "- ❬ `.نقل_بوت_القناة + اليوزر` ❭\n"
            "لـ نقـل اليـوزر من قناتك إلى بوت فـاذر (@BotFather).\n"
            "**~الاستخدام** : `.نقل_بوت_القناة @userbot`\n\n"
            
            "- ❬ `.نقل_بوت_الحساب + اليوزر` ❭\n"
            "لـ نقـل اليـوزر من حسـابك إلى بوت فـاذر (@BotFather).\n"
            "**~الاستخدام** : `.نقل_بوت_الحساب @userbot`\n\n"
            
            "- ❬ `.نقل_ملكية + معرف الشخص` ❭\n"
            "لـ نقـل ملكيـة القنـاة من حسـابك إلى شخـص آخـر.\n"
            "**~الاستخدام** : `.نقل_ملكية @username`\n\n"

            "- ❬ `.نقل_بوت_لقناة + اليوزر` ❭\n"
            "لـ نقـل اليـوزر من بوت فـاذر (@BotFather) إلى قنـاة جديـدة.\n"
            "**~الاستخدام** : `.نقل_بوت_لقناة @userbot`\n\n"

            "- ❬ `.الصيد` & `.التثبيت` ❭\n"
            "لـ عرض اوامر الصيد & التثبيت .\n\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★➖\n⌔ Dev : @Lx5x5"
        )
