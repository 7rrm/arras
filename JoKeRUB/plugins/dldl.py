    ...
    try:
        ...
        if step == 1:
            if event.contact:
                ...
                return await l313l.tgbot.send_message(event.chat_id, "**• يرجى استخدام زر إرسال رقم الهاتف فقط**")
        ...
        if step == 2:
            ...
            if res == 0:
                ...
                return await l313l.tgbot.send_message(event.chat_id, "**• الكود غير صالح أو منتهي الصلاحية!**")
            else:
                return await l313l.tgbot.send_message(
                    event.chat_id,
                    "**• حدث خطأ غير معروف\n• يرجى المحاولة مرة أخرى بعد بضع دقائق**"
