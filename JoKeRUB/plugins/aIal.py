...
ZelzalChecler_cmd = (
    ...
    "⏺️ **أوامر الصيد (Hunting):**\n"
    "┌─────────────────\n"
    "│ `.النوع` - عرض جميع الأنواع المتاحة مع أمثلة\n"
    "│ `.الانواع` - نفس الأمر السابق\n"
    "│ `.صيد` + النوع - بدء صيد يوزرات حسب النوع\n"
    "│ `.حالة الصيد` - عرض حالة عملية الصيد الحالية\n"
    "│ `.صيد ايقاف` - إيقاف عملية الصيد الجارية\n"
    "└─────────────────\n\n"
    
    "⏺️ **أوامر التثبيت (Reservation):**\n"
    "┌─────────────────\n"
    "│ `.تثبيت_قناة` + @يوزر - تثبيت يوزر في قناة\n"
    "│ `.تثبيت_حساب` + @يوزر - تثبيت يوزر في حسابك\n"
    "│ `.تثبيت_بوت` + @يوزر - تثبيت يوزر في بوت\n"
    "└─────────────────\n\n"
    
    "⏺️ **أوامر حالة التثبيت:**\n"
    "┌─────────────────\n"
    "│ `.حالة تثبيت_القناة` - حالة تثبيت القناة\n"
    "│ `.حالة تثبيت_الحساب` - حالة تثبيت الحساب\n"
    "│ `.حالة تثبيت_البوت` - حالة تثبيت البوت\n"
    "└─────────────────\n\n"
    
    "⏺️ **أوامر إيقاف التثبيت:**\n"
    "┌─────────────────\n"
    "│ `.ايقاف تثبيت_القناة` - إيقاف تثبيت القناة\n"
    "│ `.ايقاف تثبيت_الحساب` - إيقاف تثبيت الحساب\n"
    "│ `.ايقاف تثبيت_البوت` - إيقاف تثبيت البوت\n"
    "└─────────────────\n\n"
    
    "⏺️ **أوامر النقل (Transfer):**\n"
    "┌─────────────────\n"
    "│ `.نقل_قناة` - نقل اليوزر الحالي من حسابك إلى قناة جديدة\n"
    "│ `.نقل_حساب` + @يوزر - نقل يوزر إلى حسابك الشخصي\n"
    "│ `.نقل_بوت_القناة` + @يوزر - نقل يوزر القناة إلى بوت\n"
    "│ `.نقل_بوت_الحساب` + @يوزر - نقل يوزر الحساب إلى بوت\n"
    "└─────────────────\n\n"
    
    "⏺️ **أوامر إضافية:**\n"
    "┌─────────────────\n"
    "│ `.الصيد` - عرض هذه القائمة (أوامر الصيد والتثبيت)\n"
    "│ `.التثبيت` - نفس الأمر السابق\n"
    "│ `.الانووااع` - عرض أنواع إضافية (VIP)\n"
    "└─────────────────\n\n"
    
    "⚠️ **ملاحظات مهمة قبل الاستخدام:**\n"
    "┌─────────────────\n"
    "│ ✅ تأكد من وجود مساحة لإنشاء قناة عامة في حسابك\n"
    "│ ✅ إذا لم يوجد مساحة، أرسل يوزر قناة موجودة لديك ثم رد عليه بأمر الصيد\n"
    "│ ✅ لا توقف عملية الصيد حتى لو استمرت أيام\n"
    "│ ✅ كن صبوراً وكرر المحاولات\n"
    "│ ✅ كل نوع يوزر له نسبة صيد مختلفة\n"
    "│ ✅ التثبيت لحجز يوزر محدد عند تحريره\n"
    "│ ✅ الأوامر التي تحتاج يوزر يجب أن تبدأ بـ @\n"
    "└─────────────────\n\n"
