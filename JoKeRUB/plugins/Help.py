...
# =========================================================== #
#               صفحات تفصيلية لكل أمر (التنسيق الجديد)         #
# =========================================================== #
...
async def _(event):
    text = (
        ...
        "**⦁** `.تفعيل`/`.تعطيل فيديو`\n\n"
        "**⪼ الوصـف**\n"
        "لتفعيل/ لتعطيل تحميل الفيديو لدى الآخرين \n\n"
        "**⪼ الاسـتخدام **\n"
        "`.تفعيل فيديو` في جميع المحادثات الخاصة & في مجموعة محدده \n"
        "`.تعطيل فيديو` في جميع المحادثات الخاصة & في مجموعة محدده \n\n"
        "**ملاحضه **\n"
        "عند كتابتك لللأمر في الخاص سيتم تفعيل امر الفيديو في جميع المحادثات الخاصه \n\n"
        "او عند كتابته في مجموعة سيتم أخذ هذه المجموعة فقط \n\n"
        "━━━━━━━━━━━━━━\n\n"
        "**⦁** `.فيديو`\n\n"
        "**⪼ الوصـف**\n"
        "لتحميل الفيديو من اليوتيوب\n\n"
        "**⪼ الاسـتخدام **\n"
        "`.فيديو` + رابط & `.فيديو` + كلمة"
    )
...
async def _(event):
    text = (
        ...
        "**⦁** `.تحميل صوت`\n\n"
        "**⪼ الوصـف**\n"
        "تحميـل الاغـاني مـن يوتيوب .. فيسبوك .. انستا .. الـخ عـبر الرابـط\n\n"
        "**⪼ الاسـتخدام **\n"
        "`.تحميل صوت` + رابط (فقط رابط)"
    )
...
async def _(event):
    text = (
        ...
        "**⦁** `.تحميل فيديو`\n\n"
        "**⪼ الوصـف**\n"
        "تحميـل الفيديو مـن يوتيوب .. فيسبوك .. انستا .. الـخ عـبر الرابـط\n\n"
        "**⪼ الاسـتخدام **\n"
        "`.تحميل فيديو` + رابط (فقط رابط)"
    )
...
# =========================================================== #
#               باقي الصفحات (بنفس التنسيق الجديد)            #
# =========================================================== #
...
async def _(event):
    text = (
        ...
        "**⦁** `.مساعدة`\n\n"
        "**⪼ الوصـف**\n"
        "لعرض قائمة المساعدة التفاعلية\n\n"
        "**⪼ الاسـتخدام **\n"
        "`.مساعدة`\n\n"
        "━━━━━━━━━━━━━━\n\n"
        "**⦁ رابط السورس**\n\n"
        "**Github:** https://github.com/username/l313l\n"
        "**القناة:** @l3_3_3l\n"
        "**المطور:** @username"
    )
...
# يمكنك إضافة باقي الأزرار بنفس التنسيق...
