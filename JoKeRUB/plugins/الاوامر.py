...
caption = f"<b>✦ قائـمة اوامـر سـورس آراس </b>"
    caption += f'<a href="emoji/4909197170365695119">‎</a>\n'
    
    # إضافة الإيموجيات البريميوم قبل كل قسم مع تعديل الأوامر لخط النسخ
    caption += (
        f'<a href="emoji/6323136954380585694">‎</a> <code>.م1</code> ⦙ أوامر الإدارة\n'
        f'<a href="emoji/6325684673145997914">‎</a> <code>.م2</code> ⦙ أوامر المجموعة\n'
        f'<a href="emoji/6323205570778107774">‎</a> <code>.م3</code> ⦙ أوامر الترحيب والردود\n'
        f'<a href="emoji/6323518746908428943">‎</a> <code>.م4</code> ⦙ حماية الخاص والتلكراف\n'
        f'<a href="emoji/5834774412338927340">‎</a> <code>.م5</code> ⦙ أوامر المنشن والانتحال\n'
        f'<a href="emoji/6325480992911919689">‎</a> <code>.م6</code> ⦙ أوامر التحميل والترجمة\n'
        f'<a href="emoji/6323564170482551899">‎</a> <code>.م7</code> ⦙ أوامر المنع والقفل\n'
        f'<a href="emoji/6323191058083613275">‎</a> <code>.م8</code> ⦙ أوامر التنظيف والتكرار\n'
        f'<a href="emoji/6325310787652946500">‎</a> <code>.م9</code> ⦙ أوامر التخصيص والفارات\n'
        f'<a href="emoji/6323136954380585694">‎</a> <code>.م10</code> ⦙ أوامر الوقتي والتشغيل\n'
        f'<a href="emoji/6325684673145997914">‎</a> <code>.م11</code> ⦙ أوامر الكشف والروابط\n'
        f'<a href="emoji/6323205570778107774">‎</a> <code>.م12</code> ⦙ أوامر المساعدة والإذاعة\n'
        f'<a href="emoji/6323518746908428943">‎</a> <code>.م13</code> ⦙ أوامر الإرسال والأذكار\n'
        f'<a href="emoji/5834774412338927340">‎</a> <code>.م14</code> ⦙ أوامر الملصقات وكوكل\n'
        f'<a href="emoji/6325480992911919689">‎</a> <code>.م15</code> ⦙ أوامر التسلية والميمز\n'
        f'<a href="emoji/6323564170482551899">‎</a> <code>.م16</code> ⦙ أوامر الصيغ والجهات\n'
        f'<a href="emoji/6323191058083613275">‎</a> <code>.م17</code> ⦙ أوامر التمبلر والزغرفة\n'
        f'<a href="emoji/6325310787652946500">‎</a> <code>.م18</code> ⦙ أوامر الحساب والترفيه\n'
        f'<a href="emoji/6323136954380585694">‎</a> <code>.م19</code> ⦙ أوامر الميوزك والتشغيل\n'
        f'<a href="emoji/6325684673145997914">‎</a> <code>.م20</code> ⦙ أوامر بصمات الميمز\n'
        f'<a href="emoji/6323205570778107774">‎</a> <code>.م21</code> ⦙ أوامر تجميع النقاط وبوت وعد\n'
        f'<a href="emoji/6323518746908428943">‎</a> <code>.م22</code> ⦙ أوامر الذاتية للبصمات والصور\n'
        f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
        f"<b>📜┊ حكمة اليوم:</b>\n"
        f"<code>{lMl10l}</code>\n"
        f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
        f'<a href="emoji/5834774412338927340">‎</a> <b>⚡ المطور: @Lx5x5</b>\n'
        f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
    )
