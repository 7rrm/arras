...
❐ طريقة الاستخدام: .النشر تفعيل

☑️ ⦗ `.النشر تعطيل` ⦘
❐ لـ تعطيل امر منع النضر
❐ طريقة الاستخدام: .النشر تعطيل
...
☑️ ⦗ `.احذف` ⦘
❐ لـ حذف دردشة مع شخص 
❐ طريقة الاستخدام: .احذف + يوزر الشخص
...
async def _(event):
    await event.edit(
        """𓆩 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐑𝐀𝐒 - أوامر الذكاء 𓆪
━━━━━━━━━━━━━━━━━━━━

☑️ ⦗ `.ار` ⦘
❐ ذكاء اصطناعي متطور يجيب على جميع أسئلتك يقوم بحفظ الاسئله السابقة
❐ طريقة الاستخدام: .ار + سؤال

☑️ ⦗ `.ارسم` ⦘
❐ لـ رسم صور بالذكاء الاصطناعي 
❐ طريقة الاستخدام: .ارسم + الكليشة
