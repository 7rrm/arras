...
☑️ ⦗ `.تفعيل ترحيب الايدي` ⦘
❐ لتفعيل الترحيب بكلايش مختلفة عندما يرسل شخص في المجموعة ا
❐ طريقة الاستخدام: .تفعيل ترحيب الايدي داخل مجموعة

☑️ ⦗ `.تعطيل ترحيب الايدي` ⦘
❐ لـ تعطيل ترحيب الايدي
❐ طريقة الاستخدام: إرسال الأمر فقط لتعطيل الامر بالمجموعة التي فعلت الامر بها
