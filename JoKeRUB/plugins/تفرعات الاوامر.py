...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            ...
            "᯽︙ اختر احدى هذه الاوامر \n\n"
            "★ أوامر معاني السمايلات ★\n"
            "( `.تفعيل معاني` ) \n"
            "- تفعيل البوت للرد على السمايلات في المجموعة الحالية.\n\n"
            "( `.تعطيل معاني` )\n"
            "- تعطيل البوت عن الرد على السمايلات في جميع المجموعات.\n\n\n"
            "★ أوامر تفكيك الكلمات ★\n"
            "( `.تفعيل تفكيك` )\n"
            "- تفعيل البوت لتفكيك الكلمات في المجموعة الحالية.\n\n"
            "( `.تعطيل تفكيك` )\n"
            "- تعطيل البوت عن تفكيك الكلمات في جميع المجموعات.\n\n"
            "\n"
            "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n"
            "⌔︙Dev : @lx5x5"
	)
